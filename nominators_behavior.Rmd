...
remove_1kv_nominators <- function(overall_nominators){
  # List of excluded stash addresses
  exclude_values <- c(
  ...
  # Filter out rows where stash_address is in exclude_values
...
new <- Sys.time() - old 
message(paste0("Script compiliation took ", round(new,1), " Minutes"))
```
...
<table style="border-collapse:collapse;border-spacing:0" class="tg"><thead><tr><th style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Metric</th><th style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"></th></tr></thead>
<tbody><tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">First Session Number (Date)</td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r first_session` (`r as.Date(as.POSIXct(session_timestamps[[as.character(first_session)]], origin = "1970-01-01", tz = "UTC"))`)</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Last Session Number (Date)</td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"><span style="font-weight:400;font-style:normal">`r last_session` (</span><br>`r as.Date(as.POSIXct(session_timestamps[[as.character(last_session)]], origin = "1970-01-01", tz = "UTC"))`)</td></tr>
<tr><td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Maximum Inaccuracy</td><td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(time_offset / 6, digit = 0)` days</td></tr><tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Total unique Nominators</td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r nrow(overall_nominators)`</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Currently active Nominators</td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r nrow(overall_nominators_active)`</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Average number of bonded amount changes (all nominators)</td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(overall_nominators$nr_amount_changed), digit = 1)`</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"><span style="font-weight:400;font-style:normal">Average days since last bonded amount change (currently active nominators)</span></td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(overall_nominators_active$days_since_bonded_amount_changed), digit = 0)` days</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"><span style="font-weight:400;font-style:normal">Average number of target changes (all nominators)</span></td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(overall_nominators$nr_targets_changed), digit = 1)`</td></tr>
<tr><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"><span style="font-weight:400;font-style:normal">Average days since last target change (currently active nominators)</span></td><td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal"><span style="font-weight:400;font-style:normal">`r round(mean(overall_nominators_active$days_since_target_changed), digit = 0)` days</span></td></tr>
<tr><td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Share of Nominators with at least one inactive validator nominated (currently active nominators)</td><td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(merged_aggregated$at_least_one_inactive), digit = 2)*100`%</td></tr></tbody></table>

## Distribution of Target and Bonded Amount Changes
The following two graphs give a better perspective about the distribution of the two variables.

### Number of Bonded Amount Changes
...
In this section, we analyze in greater detail how the backing of Validators is composed. The key metric we are focusing on here is the weighted average days since a change occurred in nominations (targets) by the nominators. This is what we call *Weighted Backing Age* and it gives an idea of how much of the backing of a Validator is from very early nominations. 

This metric is expressed on a per-validator basis. To calculate it, we analyze all nominators of each Validator with respect to the time they last changed their nomination and how much backing they provide for the Validator. Instead of taking simply the average of the days since a change of targets occurred of their nominations, we additional weigh them by the backing they provide. 

Consider the following example: Let's assume a Validator has only two nominators A and B. Nominator A is backing the Validator and has not updated their targets since 50 days and has a bonded amount of 5000 DOT. Nominator B is backing the Validator since 1000 days and has a bonded amount of 20000 DOT. Instead of the average backing being 50+1000 / 2 = 525 days, we incorporate the fact that one nominator contributes much more to the backing than the other. Mathematically, we would be calculating: 5000 / (20000+5000) * 50 + 20000 / (20000+5000) * 1000 = 810. 

This metric gives a better understanding of the **Weighted Backing Age** of each Validator.

The following graph plots the density of this metric for all Validators in the active set.
...
Given the data above, we can say, for example, that `r result$value` of the density is above `r threshold` days (or 6 months).
...
ggplot(validator_staleness_summary, aes(x = weighted_avg_days_since_change)) +
  geom_histogram(binwidth = 1, color = "black", fill = "lightblue") +
  labs(title = "Histogram of Weighted Backing Age",
       x = "Weighted Backing Age", y = "Frequency")
```

The following table sorts each validator based on their weighted backing age and provides the name and stash address. Validators without a set identity are labelled "pseudo-a".
