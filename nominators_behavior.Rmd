...
# Specify folder in case you already got staking data .csv
path <- "~/Documents/staking-data"
```
...
last_session = 11080 # 9442 for one of last sessions with 297 vals
...
missing_tables <- 0
requested_tables <- number_tables
missing_pool_info <- 0
```
...
nominators_t0 <- polkadotutils::importStakingData("nominators", "session", sessions[1], chain, TRUE, path)
# Getting the newest validator information (which we need later)
validator_newest <- polkadotutils::importStakingData("validators", "session", last_session, chain, TRUE, path)
...
for (i in 2:length(sessions)) {
  ...
  nominators_next <- tryCatch(
    {
      importStakingData("nominators", "session", sessions[i], chain, TRUE, path)
    },
    error = function(e) {
      message(paste("Error in session", sessions[i], "- skipping. Error message:", e$message))
      flush.console()  # Force the error message to be displayed immediately
  ...
  if (is.null(nominators_next) == FALSE & is.null(nominators_next$is_nomination_pool)){
    nominators_next$is_nomination_pool <- FALSE
    missing_pool_info <<- missing_pool_info + 1
  }
  ...
  if (i %% 10 == 0) {
    ...
    flush.console()  # Force the save message to be displayed immediately
  }
...
<table style="border-collapse:collapse;border-spacing:0" class="tg">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(time_offset / 6, digit = 0)` day(s)</td>
    </tr>
    <tr>
      <td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Analyzed Tables (of those missing tables)</td>
      <td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r requested_tables` (`r missing_tables`)</td>
    </tr>
    <tr>
      <td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Missing Pool Info</td>
      <td style="border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r missing_pool_info`</td>
    </tr>
  </tbody>
</table>
...
<table style="border-collapse:collapse;border-spacing:0" class="tg">
  ...
  <tbody>
    ...
    <tr>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Maximum Inaccuracy</td>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(time_offset / 6, digit = 0)` days</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Average days since last target change (all currently active nominators)</td>
    ...
    <tr>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Average days since last target change (only active nomination pools)</td>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(subset(overall_nominators_active, is_pool == TRUE)$days_since_target_changed), digit = 0)` days</td>
    </tr>
    <tr>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">Share of Nominators with at least one inactive validator nominated (currently active nominators)</td>
      <td style="border-color:inherit;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">`r round(mean(merged_aggregated$at_least_one_inactive), digit = 2)*100`%</td>
    </tr>
  </tbody>
</table>
